...
public class Speed {
    ...
    public Speed(Core core){
        ...
        command.getMensagens().createMensagens(() -> {
            ...
            config.set("Velocidade_Alterada", "&aVocê alterou sua velocidade de caminhar para &2{velocidade}!");
            config.set("Velocidade_Alterada_ActionBar", "&aVocê alterou sua velocidade para &2{velocidade}!");
